...
<%
	...
	ResultSet selectPrivileges = selectPrivilege
			.executeQuery("Select ExamID, Grade from Grades where StudentID = " + userID);
	Statement selectExamName = connection.createStatement();
...
<body>
	...
	<div class="content1">
		<label><%=session.getAttribute("userName")%> Grades</label>
	</div>
		...
		<table class="table table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td><%=examName.getString("TotalMark")%></td>
					<%
						}
					%>
					<td><%=selectPrivileges.getDouble("Grade")%></td>
				</tr>
				<%
					}
				%>
